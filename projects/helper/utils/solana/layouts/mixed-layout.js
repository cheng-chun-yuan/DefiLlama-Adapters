...
// New GuardianSetting Layout
const GUARDIAN_SETTING_LAYOUT = BufferLayout.struct([
...
module.exports = {
  ...
  PARLAY_LAYOUT_PARTIAL, HH_PARI_LAYOUT_PARTIAL, ACCESS_LAYOUT, METEORA_STABLE_SWAP_LAYOUT, GUARDIAN_SETTING_LAYOUT
}
